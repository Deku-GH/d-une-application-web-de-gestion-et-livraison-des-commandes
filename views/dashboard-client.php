...
$sql = "SELECT id, description, addrese, status,Ville FROM commendes ORDER BY id DESC";
...
<body class="bg-gray-50">
                    ...
                    <div class="relative">
                        <button id="notificationBtn"
                            ...
                            <span id="notificationBadge"
                                class="absolute top-0 right-0 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center hidden">3</span>
                        </button>
                    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Colis fragile -
                                    Électronique</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">123 Rue Example, Paris
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="commande-detail.html?id=1"
                                        class="text-indigo-600 hover:text-indigo-900 mr-3">Voir</a>
                                    <button class="text-red-600 hover:text-red-900">Supprimer</button>
                                </td>
                            </tr>
                            <?php foreach ($commendes as $cmd): ?>
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap"><?php echo htmlspecialchars($cmd['id']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php echo htmlspecialchars($cmd['description']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap"><?php echo htmlspecialchars($cmd['addrese']); ?>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap"><?php echo htmlspecialchars($cmd['status']); ?>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php echo htmlspecialchars($cmd['Ville']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <a href="commande-detail.php?id=<?php echo $cmd['id']; ?>">Voir</a> |
                                      <button class="text-red-600 hover:text-red-900">Supprimer</button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
    ...
    <div id="newOrderModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <form id="newOrderForm" action="../App/Controllers/curdcommande.php" method="post" class="p-6 space-y-4">
                <div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="ville" requiredopiuity
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
                    </div>
                    <div>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Type de colis</label>
            ...
            <div class="p-6 max-h-96 overflow-y-auto">
                <div class="space-y-4">
                    ...
                    <div class="p-4 bg-green-50 border-l-4 border-green-500 rounded">
                        ...
                        <p class="text-xs text-gray-600 mt-1">Votre commande #002 est maintenant en cours de traitement
                        </p>
